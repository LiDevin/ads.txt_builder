import type { PropertyDetail, PropertySummary, PropertyType, PropertyVersion, VersionStore, VersionSummary } from "./types";
...
export class FakeVersionStore implements VersionStore {
  constructor(private readonly properties: FakeProperty[]) {}
